...
tools: Read, Grep, Glob, Edit, Write, Bash, Task, mcp__web-search__web_search, mcp__deepwiki__ask_question, mcp__code-review-graph__get_impact_radius_tool, mcp__code-review-graph__query_graph_tool, mcp__code-review-graph__get_review_context_tool, mcp__code-review-graph__semantic_search_nodes_tool, mcp__code-review-graph__build_or_update_graph_tool
model: sonnet
---
# Senior Dev  (dev mode)
